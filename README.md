...
- brittle config that needs to map over know directories
- rename theme-6 from "new" to something
- alpha values: https://github.com/amzn/style-dictionary/tree/3.0/examples/advanced/transitive-transforms
